...
class Application_Acl_Setup
{
    ...
    protected function _setupPrivileges()
    {
        ...
        $this->_acl	->allow( 'user', 'index', 'index' )
                    ...
                    ->allow( 'user', 'api', array('subgoals','presence','getmember','getparticipants','saveparticipant','reunioes','cell','suggestions','date-multiplication') )
        ...
        $this->_acl	->allow( 'admin', 'index', 'index' )
                    ...
                    ->allow( 'admin', 'api', array('subgoals','presence','getmember','getparticipants','saveparticipant','reunioes','cell','suggestions','date-multiplication') )
