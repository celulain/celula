...
class Application_Acl_Setup
{
    ...
    protected function _setupPrivileges()
    {
        $this->_acl	->allow( 'guest', 'index', 'index' )
                    ...
                    ->allow( 'guest', 'fixtures', array('participants', 'cells', 'churches', 'meetings', 'members', 'lessons', 'suggestions', 'praises', 'dynamics', 'cell-profiles') )
        ...
        $this->_acl	->allow( 'user', 'index', 'index' )
                    ...
                    ->allow( 'user', 'api', array('subgoals','presence','getmember','getparticipants','saveparticipant','reunioes','cell','suggestions') )
        ...
        $this->_acl	->allow( 'admin', 'index', 'index' )
                    ...
                    ->allow( 'admin', 'api', array('subgoals','presence','getmember','getparticipants','saveparticipant','reunioes','cell','suggestions') )
